...
import LogoThemeProvider from "./theme/LogoThemeProvider";
...
const applyCachedBrandTheme = () => {
  ...
  try {
    ...
    const buttonTextColor = normalizeHexColor(website?.buttonTextColor, "#ffffff");
    document.documentElement.style.setProperty("--brand-theme-color", themeColor);
    document.documentElement.style.setProperty("--brand-button-text-color", buttonTextColor);
    document.documentElement.style.setProperty("--brand-theme-shadow", hexToRgba(themeColor, 0.24));
  } catch {}
};
